...
\includegraphics[width=0.14\linewidth]{figs/splash1/original} &
\includegraphics[width=0.14\linewidth]{figs/splash1/panda} &
\includegraphics[width=0.14\linewidth]{figs/splash1/tiger} &
\includegraphics[width=0.14\linewidth]{figs/splash1/gorilla} &
\includegraphics[width=0.14\linewidth]{figs/splash1/lion} &
\includegraphics[width=0.14\linewidth]{figs/splash1/elephant} &
\includegraphics[width=0.14\linewidth]{figs/splash1/localization}\\
{\small (a) Input Image} &
{\small (b) Panda} &
{\small (c) Tiger} &
{\small (d) Gorilla} &
