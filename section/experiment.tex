...
\hline
AlexNet~\cite{Krizhevsky2012ImageNet} & 47.1 \\
VggNet~\cite{Simonyan2014Very} & 42.3 \\
GooglNet~\cite{Szegedy2014Going} & \textbf{40.1} \\
\hline
\end{tabular}
...
\hline
Oxford~\cite{simonyan2013deep} & 44.7 \\
Deconv~\cite{zeiler2014visualizing} & 46.9 \\
Feedback & \textbf{42.3} \\
\hline
\end{tabular}
